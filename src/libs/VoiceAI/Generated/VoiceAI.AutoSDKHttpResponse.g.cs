...
namespace VoiceAI
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::VoiceAI.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::VoiceAI.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::VoiceAI.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::VoiceAI.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::VoiceAI.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::VoiceAI.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::VoiceAI.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::VoiceAI.ApiException exception)
        ...
        private static global::VoiceAI.AutoSDKRequestOptions CloneRequestOptions(
            global::VoiceAI.AutoSDKRequestOptions? source)
        {
            var clone = new global::VoiceAI.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
