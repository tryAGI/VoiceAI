...
namespace VoiceAI
{
    public partial interface IAgentKnowledgeBaseClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::VoiceAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::VoiceAI.AutoSDKHttpResponse<string>> AssignKnowledgeBaseToAgentApiV1AgentAgentIdAssignKnowledgeBasePostAsResponseAsync(
            string agentId,
