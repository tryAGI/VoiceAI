                    ...
                    await global::VoiceAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::VoiceAI.AgentOutput.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::VoiceAI.AgentOutput.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
