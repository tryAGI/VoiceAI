...
namespace VoiceAI
{
    public partial class AgentConnectionClient
    {
        ...
        {
            var __response = await GetConnectionDetailsApiV1ConnectionConnectionDetailsPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::VoiceAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::VoiceAI.AutoSDKHttpResponse<global::VoiceAI.ConnectionDetailsResponse>> GetConnectionDetailsApiV1ConnectionConnectionDetailsPostAsResponseAsync(
                    ...
                    await global::VoiceAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::VoiceAI.ConnectionDetailsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::VoiceAI.AutoSDKHttpResponse<global::VoiceAI.ConnectionDetailsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::VoiceAI.ConnectionDetailsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
