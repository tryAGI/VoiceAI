                    ...
                    await global::VoiceAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::VoiceAI.KnowledgeBaseWithDocuments.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::VoiceAI.KnowledgeBaseWithDocuments.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
