...
namespace VoiceAI
{
    public partial interface IAgentManagementClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::VoiceAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::VoiceAI.AutoSDKHttpResponse<global::VoiceAI.PaginatedAllPhoneNumbersResponse>> GetAllPhoneNumbersApiV1AgentPhoneNumbersGetAsResponseAsync(
            int? page = default,
            int? limit = default,
            global::VoiceAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
