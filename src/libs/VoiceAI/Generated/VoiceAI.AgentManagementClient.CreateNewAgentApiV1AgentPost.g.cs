...
namespace VoiceAI
{
    public partial class AgentManagementClient
    {
        ...
        private static readonly global::VoiceAI.EndPointSecurityRequirement s_CreateNewAgentApiV1AgentPostSecurityRequirement0 =
        ...
        private static readonly global::VoiceAI.EndPointSecurityRequirement[] s_CreateNewAgentApiV1AgentPostSecurityRequirements =
            new global::VoiceAI.EndPointSecurityRequirement[]
            {                s_CreateNewAgentApiV1AgentPostSecurityRequirement0,
            };
        partial void PrepareCreateNewAgentApiV1AgentPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::VoiceAI.CreateAgentRequest request);
        partial void PrepareCreateNewAgentApiV1AgentPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::VoiceAI.CreateAgentRequest request);
        partial void ProcessCreateNewAgentApiV1AgentPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateNewAgentApiV1AgentPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::VoiceAI.AgentOutput> CreateNewAgentApiV1AgentPostAsync(

            global::VoiceAI.CreateAgentRequest request,
            global::VoiceAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateNewAgentApiV1AgentPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::VoiceAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::VoiceAI.AutoSDKHttpResponse<global::VoiceAI.AgentOutput>> CreateNewAgentApiV1AgentPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateNewAgentApiV1AgentPostArguments(
            ...
            var __authorizations = global::VoiceAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateNewAgentApiV1AgentPostSecurityRequirements,
                operationName: "CreateNewAgentApiV1AgentPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateNewAgentApiV1AgentPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::VoiceAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::VoiceAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateNewAgentApiV1AgentPost",
                                methodName: "CreateNewAgentApiV1AgentPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateNewAgentApiV1AgentPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::VoiceAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateNewAgentApiV1AgentPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::VoiceAI.AgentOutput> CreateNewAgentApiV1AgentPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::VoiceAI.CreateAgentRequest
            {
                Name = name,
                Config = config,
                KbId = kbId,
            ...
            return await CreateNewAgentApiV1AgentPostAsync(
                request: __request,
                requestOptions: requestOptions,
