...
namespace VoiceAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::VoiceAI.AutoSDKRetryOptions Retry { get; set; } = new global::VoiceAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::VoiceAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::VoiceAI.IAutoSDKHook>();
        ...
        public global::VoiceAI.AutoSDKClientOptions AddHook(
            global::VoiceAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::VoiceAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::VoiceAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::VoiceAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::VoiceAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::VoiceAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::VoiceAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::VoiceAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::VoiceAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::VoiceAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::VoiceAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::VoiceAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::VoiceAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::VoiceAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::VoiceAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::VoiceAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::VoiceAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::VoiceAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::VoiceAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::VoiceAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::VoiceAI.AutoSDKClientOptions clientOptions,
            global::VoiceAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::VoiceAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::VoiceAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::VoiceAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::VoiceAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::VoiceAI.IAutoSDKHook, global::VoiceAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::VoiceAI.AutoSDKHookContext context)
        {
